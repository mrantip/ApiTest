...
public @interface FraudCheckMock {
    ...
    /**
     * Статус проверки фрода для GET запроса
     */
    String checkStatus() default "NO_FRAUD_CHECK_REQUIRED";

    /**
     * Note для ответа на GET запрос
     */
    String note() default "This transaction does not require fraud checking.";
}
